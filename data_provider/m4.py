...
INFO_FILE_PATH ='E:\Module\LTSF-Linear-main\data\M4\m4_info.csv'
...
class M4Dataset:
    ...
    @staticmethod
    def load(training: bool = True, dataset_file: str = '../dataset/m4', data_path:str = '') -> 'M4Dataset':
        """
        Load cached dataset.
        ...
        train_cache_file = os.path.join(dataset_file, data_path+'-train.csv')
        test_cache_file = os.path.join(dataset_file, data_path+'-test.csv')
