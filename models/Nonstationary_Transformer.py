...
from layers.Transformer_EncDec1 import Decoder, DecoderLayer, Encoder, EncoderLayer
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Embedding
        self.enc_embedding = DataEmbedding(configs.enc_in, configs.d_model, configs.embed, configs.freq, configs.wo_freq,
                                           configs.dropout)
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast':
            self.dec_embedding = DataEmbedding(configs.dec_in, configs.d_model, configs.embed, configs.freq, configs.wo_freq,
                                               configs.dropout)
